...
export const metadata: Metadata = {
  ...
  description:
    "International regulatory framework for aviation health and safety: ICAO, WHO IHR 2005, EASA, FAA, and Azerbaijan SCAA.",
};

export default async function RegulatoryFrameworkPage() {
  const content = await getSectionContent("regulatory-framework");
  if (!content) notFound();
